...
func TestCompleteMagicLink_ValidTokenIssuesTokens(t *testing.T) {
	...
	tokens, err := CompleteMagicLink(ctx, users, sessions, verifications, nil, nil, ids, refreshGen, jwtIssuer, pendingIssuer, audit, log, sender.rawToken, "1.2.3.4", "test-agent")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestCompleteMagicLink_TokenIsSingleUse(t *testing.T) {
	...
	if _, err := CompleteMagicLink(ctx, users, sessions, verifications, nil, nil, ids, refreshGen, jwtIssuer, pendingIssuer, audit, log, sender.rawToken, "1.2.3.4", "test-agent"); err != nil {
		t.Fatalf("unexpected error on first use: %v", err)
	}

	_, err := CompleteMagicLink(ctx, users, sessions, verifications, nil, nil, ids, refreshGen, jwtIssuer, pendingIssuer, audit, log, sender.rawToken, "1.2.3.4", "test-agent")
...
func TestCompleteMagicLink_ExpiredTokenRejected(t *testing.T) {
	...
	_, err := CompleteMagicLink(ctx, users, sessions, verifications, nil, nil, ids, refreshGen, jwtIssuer, pendingIssuer, audit, log, rawToken, "1.2.3.4", "test-agent")
...
func TestCompleteMagicLink_AccountWithTOTPPausesForSecondFactor(t *testing.T) {
	...
	_, err := CompleteMagicLink(ctx, users, sessions, verifications, totpStore, nil, ids, refreshGen, jwtIssuer, pendingIssuer, audit, log, sender.rawToken, "1.2.3.4", "test-agent")
